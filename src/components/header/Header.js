            ...
            <Navbar expand="lg" data-bs-theme="dark" className="header__nav">
                <Container>
                       ...
                       <Nav className="d-flex justify-content-end align-items-center header__nav-links">
                            <Nav.Link href="/" className="header__nav-item">Обо мне</Nav.Link>
                            <Nav.Link href="/portfolio" className="header__nav-item">Мои работы</Nav.Link>
                            <Nav.Link href="https://drive.google.com/file/d/1cRDBovaNghoyrYWXkHwTwxTHaDysxC9N/view?usp=sharing" className="header__nav-item">Резюме</Nav.Link>
                       </Nav>
                </Container>
            </Navbar>
        </header>
